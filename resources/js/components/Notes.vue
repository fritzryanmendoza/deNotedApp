    ...
    <div class="w-25 text-white noteappsvgcursorchanger">
        <form @submit.prevent="saveData">
            ...
            <div class="row">
                ...
                <button type="button" class="btn btn-success bg-transparent font-weight-bolder mb-2" data-toggle="modal" data-target="#modalLabel">
                CREATE A NOTE
                </button>
                </div>
            </div>
            ...
            <div class="bg-primary modal-dialog rounded-circle" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title text-white w-100" id="modalLabel">CREATE NOTE</h5>
                ...
                <div class="modal-footer" style='border: none;'>
                    ...
                    <button class="btn btn-outline-success btn-lg rounded bg-transparent text-white" type="submit">Add Note</button>
                </div>
                </div>
            </div>
            </div>
    ...
    export default {
        ...
        methods:{
            deleteNotes(db){
                ...
                axios.post('/api/notes/' + db.id, data).then((res)=>{
                    this.notes = res.data
                }).catch((error) =>{
            ...
            updateNotes(db){
                ...
                axios.post('/api/notes/' + db.id, data).then(()=>{
                }).catch((error) =>{
                    this.form.errors.record(error.response.data.errors)
                })
